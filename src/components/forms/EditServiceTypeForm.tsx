...
export function EditServiceTypeForm({ serviceType, onSuccess }: EditServiceTypeFormProps) {
  const { updateServiceType } = useData();
  ...
  const form = useForm<ServiceTypeFormData>({
    ...
    defaultValues: {
      ...
      precoBase: serviceType.precoBase,
      precoMinimo: serviceType.precoMinimo,
      precoMaximo: serviceType.precoMaximo,
      descricao: serviceType.descricao || '',
      ativo: serviceType.ativo ?? true,
    },
  });
